...
public class CKEditorConfig implements Cloneable {
	...
	/**
	 * Creates the {@code CKEditorConfig} object and initializes the
	 * {@code Map} storing editor instance configuration options.
	 */
	 ...
	 * 
	 * @param eventHandler
	 *            the {@code EventHandler} object whose events will be merged
	 *            with the cloned {@code CKEditorConfig} object.
	 ...
	 * {@code Map} with the configuration options {@code Map} of
	 * the {@code CKEditorConfig} object provided as a parameter.<br>
	 ...
	 * 
	 * @param cfg
	 *            the {@code CKEditorConfig} object whose configuration options
	 *            {@code Map} will be merged with this {@code CKEditorConfig}
