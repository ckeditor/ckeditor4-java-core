...
public class CKEditor {
    ...
    /**
     * Attributes for the {@code <textarea>} element that will be inserted into
     * JSP and replaced with CKEditor.
     */
     ...
     * makes sure that only one set of these parameters is inserted into
     * JSP.<br>
     ...
     * scriptlet (unrecommended) before the first {@code CKEditor} object
     * code.<br>
     ...
     *
     * @param creationMethod the {@code Enum} marker representing the CKEditor
     * JavaScript creation method.
     */
     ...
     * {@code <textarea>} elements which will be replaced by editor instances.
     *
    ...
    /**
     * Sets the name of the CSS marker class used to identify {@code <textarea>}
     * elements which will be replaced by editor instances.
     *
     * @param className a string representing the name of the CSS marker class.
     *
     */
     ...
     * values for the {@code <textarea>} element that will be inserted into JSP
     * and replaced by an editor instance.
     * <p>
     ...
     * and {@code form}.
     *
     * @param textareaAttributes the {@code Map} of {@code <textarea>}
     * attributes.
     */
     ...
     * instance configuration.
     *
     * @param config the {@code CKEditorConfig} object with the editor
     * configuration.
     */
     ...
     * instance.
     *
     * @param instanceName a string representing the editor instance name.
     */
     ...
     * instance upon its creation.
     *
     * @param value the initial HTML value for the editor.
     */
     ...
     * will add it.
     *
     * @param basePath a string representing the base path.
     */
     ...
     * upgrading.
     *
     * @param timestamp a string of characters representing a timestamp.
     */
