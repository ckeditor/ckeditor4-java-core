...
public class CKEditor {
	 ...
	 *            {@code <textarea>} elements that will be replaced with
	 *            CKEditor.
	 */
	public CKEditor ( HttpServletRequest request, String basePath,
			String className ) {
	 ...
	 *            should be used to create editor instances. Only
	 ...
	 *            CKEditor installation directory.
	 * @param instanceName
	 *            the name or ID of the {@code <textarea>} element that is to be
	 *            inserted into JSP.
	 * @param value
	 *            the initial HTML code for a CKEditor instance.
	 * @param textareaAttributes
	 *            the {@code Map} of key-value pairs representing
	 *            {@code <textarea>} attributes and their values. The list of
	 *            attributes can be found on the <a
