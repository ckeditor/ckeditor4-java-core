...
public class CKEditorInsertTag extends CKEditorTag {
     ...
     *
     * @param editor the name of the editor instance which matches the ID or
     ...
     * created.
     *
     * @param inline a {@code Boolean} flag indicating which type of editor
     * should be inserted into JSP.
     */
