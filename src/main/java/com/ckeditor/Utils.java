...
public class Utils {
	 ...
	 * @param args
	 *            a string formed as a query string appended to
	 *            {@code ckeditor.js}.
	 ...
	 *         empty string if the object passed as a parameter is not
	 *         supported.
	 */
	 ...
	 * 
	 * @param textAreaName
	 *            a {@code String} representing the name and ID of the
	 *            {@code <textarea>} element that will be inserted into JSP and
	 *            used to replace it with an editor instance.
	 * 
	 * @param htmlValue
	 *            a {@code String} representing the HTML value for the
	 *            {@code <textarea>} element. This HTML will be later used as
	 *            the initial value for the editor which will be created on the
	 *            {@code <textarea>} element.
	 * 
	 * @param textareaAttributes
	 *            the {@code Map} representing attributes for the
	 *            {@code <textarea>} element that will be inserted into JSP and
	 *            replaced by an editor instance.
	 * 
	 ...
	 * 
	 * @param textareaAttributes
	 *            a {@code Map} representing attributes for the
	 *            {@code <textarea>} element that will be inserted into JSP and
	 *            replaced by an editor instance.
	 * 
