...
public class Utils {
     ...
     * @return a string representing an appropriate JavaScript object or an
     * empty string if the object passed as a parameter is not supported.
     */
     ...
     *
     * @param n a {@code Number} object to encode.
     ...
     *
     * @param b a {@code Boolean} object to encode.
     ...
     *
     * @param map a {@code Map} object to encode.
     ...
     *
     * @param list a {@code List} object to encode.
     ...
     *
     *
     * @param config a {@code CKEditorConfig} object to encode.
     * @return a string representing the JavaScript object.
     */
     ...
     *
     * @param s a JavaScript string with special characters to change.
     ...
     *
     * @param textAreaName a {@code String} representing the name and ID of the
     * {@code <textarea>} element that will be inserted into JSP and used to
     * replace it with an editor instance.
     *
     * @param htmlValue a {@code String} representing the HTML value for the
     * {@code <textarea>} element. This HTML will be later used as the initial
    ...
    /**
     * Returns a {@code String} representing the {@code <textarea>} element
     ...
     *
     * @param text a string with special characters to convert.
    ...
    /**
     * Appends a slash character to the string provided that no slash is found
     * at the end of this string. If {@code null} or empty is passed as a
     * parameter, the slash character is returned.
     *
    ...
    /**
     * Checks whether the {@code String} provided as a parameter is {@code null}
     * or if it contains any characters.
     *
     * @param s the string to check.
     * @return if the string provided as a parameter is {@code null} or has 0
     * characters, {@code true} is returned. Otherwise this method returns
     * {@code false}.
     *
     */
