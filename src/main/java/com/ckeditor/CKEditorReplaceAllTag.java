...
public class CKEditorReplaceAllTag extends CKEditorTag {
	 ...
	 * 
	 * @param config
	 *            the {@code CKEditorConfig} object used to extend CKEditor
	 *            configuration which is applicable to all instances available
	 *            on JSP.
	 * 
	 ...
	 * 
	 * @param className
	 *            the CSS class name that identifies {@code <textarea>} elements
	 *            to be replaced on JSP.
	 */
