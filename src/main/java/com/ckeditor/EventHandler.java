...
public class EventHandler {
     ...
     * Adds an event.
     *
     * @param event a string representing an event name.
     * @param jsCode a string representing code for an anonymous JavaScript
     ...
     * removed.
     *
     * @param event the name of the event for which event handlers should be
     * removed or {@code null} if all event handlers for all events are to be
     * deleted.
     */
