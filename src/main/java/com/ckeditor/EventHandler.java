...
public class EventHandler {
	 ...
	 * @param jsCode
	 *            a string representing code for an anonymous JavaScript function or
	...
	/**
	 * Removes registered event handlers based on an event name provided as
	 * a parameter. If an event name is {@code null}, all event handlers will be
	 * removed.
	 * 
	 * @param event
	 *            the name of the event for which event handlers should be removed
	 *            or {@code null} if all event handlers for all events are
	 *            to be deleted.
	 */
